...
public class BubbleSort {
    public static void main(String[] args) {
        ...
        logger.info("Исходный массив: " + Arrays.toString(arrayToSort));
        ...
        for (int i = 0; i < arrayToSort.length - 1; i++) {
            ...
            logger.info("После итерации " + (i + 1) + ": " + Arrays.toString(arrayToSort));
        }

        logger.info("Итоговый массив: " + Arrays.toString(arrayToSort));
    }
